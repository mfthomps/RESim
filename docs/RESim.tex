...
\item {\tt injectIO(iofile)} -- Assumes you have previously used trackIO or otherwise have a Watch Mark corresponding to receiving data
...
the count is modified to reflect the size of the file.  The {\tt retrack} function is then invoked.  Intended use is to rapidly observe execution paths for variations in
...
\item Use traceAll to generate a system call trace.
