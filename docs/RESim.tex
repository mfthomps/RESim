...
of definition.  TBD: add {\tt NETWORK} section to the configuration file?

\subsection{Driver component}
Each network can have an optional driver component -- designated by assing the string {\tt driver} to the corresponding
...
RESim will continue the simulation until the program is execed and execution is transfered to the text segment, at which point it will pause.
...
OS-Awareness funtions.  RESim includes its own OS-Awareness functions.  The Simics Analyzer features are primarily intended to aid
