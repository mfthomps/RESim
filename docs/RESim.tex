...
records and addresses of selected kernel symbols.  A directive within the RESim configuration file directs the tool to automatically analyze the running kernel 
...
Instead of tracing all from a boot, consider running ahead until the systemd-logind is created.
