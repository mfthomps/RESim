...
# Build the fip and bl1 from u-boot and arm-trusted-firmware
# Note the fip will be populated with dtb files from
# the boot loader rather than the kernel.  The kernel dtb
# is intended to be part of an itb image. 
set -e
...
echo "Done building u-boot and bl1.  Results in $OUTPUT_DIR"
